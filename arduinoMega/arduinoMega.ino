...
#define SOLENOID_MOTOR_IN3 43
#define SOLENOID_MOTOR_IN4 41
...
void setup() {
  ...
  pinMode(SOLENOID_MOTOR_IN3, OUTPUT);
  pinMode(SOLENOID_MOTOR_IN4, OUTPUT);
  for (int i=0; i<4; i++) {
...
void loop() {
  ...
  if (irValue == HIGH) {
    ...
    digitalWrite(SOLENOID_MOTOR_IN3, LOW);
    digitalWrite(SOLENOID_MOTOR_IN4, HIGH);
    ...
    digitalWrite(GEAR_MOTOR_IN1, HIGH);
    digitalWrite(GEAR_MOTOR_IN2, LOW);
    digitalWrite(SOLENOID_MOTOR_IN3, HIGH);
    digitalWrite(SOLENOID_MOTOR_IN4, LOW);
